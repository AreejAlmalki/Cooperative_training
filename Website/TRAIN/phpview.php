...
<body>
    ...
    <ul>
        <li style=" font-family: Calibri;"> <a class="tab" href="rejected.html"> <b>الطلبات المرفوضة </b></a>
            <li>
        <li style=" font-family: Calibri;"> <a class="tab" href="accepted.html"> <b>الطلبات المقبولة </b></a>
            <li>
...
?>
    ...
    <form method="post">
        ...
        <button type="submit" class="button2 button1" name="rej" onclick="return confirm('هل تريد الرفض؟');">
            رفض</button>
   ...
   if(isset($_POST['rej'])){
    ...
    ?>
        <button class="button button1" name="ok" >قبول</button> </form>
    <?php
   if(isset($_POST['ok'])){
       
       $del="UPDATE student"." SET Status='T' WHERE id=".$id." "; 
       $result = $conn->query($del);
       echo "<script type='text/javascript'> window.location.href='ViewPage.php ?name=".$id."';</script>";
   $conn->close();
   }
