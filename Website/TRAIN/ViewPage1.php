...
?>
       ...
       <form method="post">
             ...
             <button class="button button1" href="javascript:void(0);" onclick="javascript:window.location.href='mailto:<?=$usermail?>?subject=بخصوص التدريب في أمانة منطقة  الرياض &body=السلام عليكم و رحمة الله وبركاته: نفيد سعادتكم بأن الإدارة العامة للخدمات النسائية بأمانة منطقة الرياض تعتذر عن قبول طلبكم  . &cc=<?=$sm?>;'; return false">إرسال بريد  </button>
